...
exports.get = function(origin, destination, callback) {
  ...
  if (!options.origins || options.origins === "0,0") { return callback(new Error('Argument Error: Origin is invalid')) }
  if (!options.destinations || options.destinations === "0,0") { return callback(new Error('Argument Error: Destination is invalid')) }
