...
// 
// TODO: Границы вызова должны существовать для каждого VehicleView и таким образом грузиться
// из Backend через AMQP (backend инициирует) и сохранятся в Redis для загрузки при restart
// 
// TODO: Интегрировать показ и редактирование Geofence в VehicleView Backend и 
// сохранять geoJSON в VehicleView.geofence:json
...
function Geofence() 
{
  ...
  fs.readFile(file, 'utf8', function (err, data) {
    ...
    //   console.log(util.inspect(feature.properties, {depth: 3, colors: true}));
    // })
